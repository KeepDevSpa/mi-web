...
import { Plus, Trash2, Save, Bold, Italic } from 'lucide-react';
import { IconMap, CORPORATE_COLOR_CLASSES, IconName } from '@/lib/icon-config';
...
// Iconos disponibles
const AVAILABLE_ICONS = Object.keys(IconMap) as IconName[];

// Colores corporativos con nombres amigables
const CORPORATE_COLORS = [
  { name: 'Verde Prisma', value: CORPORATE_COLOR_CLASSES.primary },
  { name: 'Dorado', value: CORPORATE_COLOR_CLASSES.secondary },
  { name: 'Blanco', value: CORPORATE_COLOR_CLASSES.white },
  { name: 'Gris claro', value: CORPORATE_COLOR_CLASSES.gray },
];
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <TipTapEditor
              ...
              placeholder="Ingrese el texto destacado (ej: de Móvil)"
            />
          ...
          <div>
            ...
            <div className="space-y-2">
              <FileExplorer
                ...
                onSelect={(path: string) => setEditing({ ...editing, heroImage: path })}
              />
              <input
                type="text"
          ...
          <div>
            ...
            <select
              ...
              className="w-full p-2 border border-gray-300 rounded"
            >
              <option value="default">Por defecto (Gris)</option>
          ...
          <div>
            ...
            {(editing.highlights || []).map((highlight, index) => (
              ...
              >
                ...
                <div className="mb-2">
                  <label className="block text-xs mb-1">Clase CSS (opcional)</label>
                  <input
                    type="text"
                    value={highlight.className || ''}
                    onChange={(e) => updateHighlight(index, 'className', e.target.value)}
                    placeholder="ej: bg-green-500 hover:bg-green-600"
                    className="w-full p-2 border border-gray-300 rounded text-sm"
                  />
                </div>
                <button
